...
import wireload_package_template
...
setup(
    ...
    version=wireload_package_template.__version__,
    description=long_description,
    author=wireload_package_template.__author__,
    author_email=wireload_package_template.__contact__,
    url=wireload_package_template.__homepage__,
